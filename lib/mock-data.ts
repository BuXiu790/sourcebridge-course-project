...
export const timeline: TimelineEvent[] = [
  ...
  {
    label: "Sample Review",
    detail: "Appearance, dimensions, reinforcement, packaging, and labeling approved.",
    date: "Jul 12",
    state: "complete",
  },
  {
    label: "In Production",
    detail: "Cutting, sewing, reinforcement, and packing milestones completed.",
    date: "Jul 15–Aug 2",
    state: "complete",
  },
  {
    label: "Quality Inspection",
    detail: "Demo pre-shipment inspection completed against the approved sample.",
    date: "Aug 4",
    state: "complete",
  },
  {
    label: "Shipping",
    detail: "Demo shipment is shown in international transit for presentation purposes.",
    date: "Aug 7",
    state: "current",
  },
  {
